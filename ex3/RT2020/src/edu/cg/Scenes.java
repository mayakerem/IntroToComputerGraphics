...
public class Scenes {
	// This class generates the 4 different scenes that we will be testing and working with 
	...
	// Many balls placed in the shape of a triangle
	...
	// Many balls placed in the shape of a triangle with big lights
